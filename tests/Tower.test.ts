...
const ladybugConfig: TowerConfig = {
...
describe('Tower', () => {
  it('initializes with correct values', () => {
    const tower = new Tower(3, 4, ladybugConfig, TILE);
  ...
  describe('update', () => {
    ...
    it('returns null when enemies out of range', () => {
      const tower = new Tower(0, 0, ladybugConfig, TILE);
    ...
    it('targets closest enemy in range', () => {
      const tower = new Tower(3, 3, ladybugConfig, TILE);
